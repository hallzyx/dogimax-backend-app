package com.dogimax.dogimaxapi.iam.infrastructure.authorization.sfs.model;
...
public class UserDetailsImpl implements UserDetails {
    ...
    public static UserDetailsImpl build(User user) {
        // Create a simple authority based on the rol field
        var authorities = List.of(new SimpleGrantedAuthority("ROLE_" + user.getRol()));
